...
// ---------------------------------------------------------------------------------------------------------------
//
// This model assumes that pain experience depends solely on the pain stimulation. 
// No effect is attributed to pain expectations, whether arising from the cue, or from cue-independent effects of the prior. 
// 
// P(R|X,Z) ~ Noraml(X, beta)
// 
// ---------------------------------------------------------------------------------------------------------------
