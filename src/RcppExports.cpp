...
RcppExport SEXP _rcpp_module_boot_stan_fit4model_2_b_multi_mod();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_stan_fit4model_2_b_multi_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4model_2_b_multi_mod, 0},
