...
#include "stanExports_model_2_b_multi.h"

RCPP_MODULE(stan_fit4model_2_b_multi_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_model_2_b_multi")
