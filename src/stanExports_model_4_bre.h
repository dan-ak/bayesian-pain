...
namespace model_model_4_bre_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_4_bre");
    reader.add_event(103, 101, "end", "model_model_4_bre");
    return reader;
}
...
class model_model_4_bre
  : public stan::model::model_base_crtp<model_model_4_bre> {
private:
        int N;
        ...
        int S;
public:
    model_model_4_bre(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_4_bre_namespace::model_model_4_bre";
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(mean_p, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            get_mean(get_base1(X, n, "X", 1), get_base1(q, n, "q", 1), get_base1(beta_n, n, "beta_n", 1), (get_base1(rho_n, n, "rho_n", 1) + (get_base1(eta_n, n, "eta_n", 1) * get_base1(std, n, "std", 1))), pstream__), 
                            "assigning variable mean_p");
                current_statement_begin__ = 69;
                stan::model::assign(std_p, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            get_std(get_base1(X, n, "X", 1), get_base1(q, n, "q", 1), get_base1(beta_n, n, "beta_n", 1), (get_base1(rho_n, n, "rho_n", 1) + (get_base1(eta_n, n, "eta_n", 1) * get_base1(std, n, "std", 1))), pstream__), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_4_bre_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_model_4_bre_namespace::model_model_4_bre stan_model;
#ifndef USING_R
