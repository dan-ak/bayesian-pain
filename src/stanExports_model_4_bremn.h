...
namespace model_model_4_bremn_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_4_bremn");
    reader.add_event(109, 107, "end", "model_model_4_bremn");
    return reader;
}
...
class model_model_4_bremn
  : public stan::model::model_base_crtp<model_model_4_bremn> {
private:
        int N;
        ...
        int S;
public:
    model_model_4_bremn(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_4_bremn_namespace::model_model_4_bremn";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_4_bremn_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_model_4_bremn_namespace::model_model_4_bremn stan_model;
#ifndef USING_R
