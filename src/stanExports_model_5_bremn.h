...
namespace model_model_5_bremn_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_5_bremn");
    reader.add_event(109, 107, "end", "model_model_5_bremn");
    return reader;
}
...
class model_model_5_bremn
  : public stan::model::model_base_crtp<model_model_5_bremn> {
private:
        int N;
        ...
        int S;
public:
    model_model_5_bremn(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_5_bremn_namespace::model_model_5_bremn";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        eta = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(-(1), 10, eta);
        } catch (const std::exception& e) {
        ...
        mu = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 100, mu);
        } catch (const std::exception& e) {
        ...
        nu = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 100, nu);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                eta = in__.scalar_lub_constrain(-(1), 10, lp__);
            else
                eta = in__.scalar_lub_constrain(-(1), 10);
            current_statement_begin__ = 48;
            local_scalar_t__ mu;
            (void) mu;  // dummy to suppress unused var warning
            if (jacobian__)
                mu = in__.scalar_lub_constrain(0, 100, lp__);
            else
                mu = in__.scalar_lub_constrain(0, 100);
            current_statement_begin__ = 49;
            local_scalar_t__ nu;
            (void) nu;  // dummy to suppress unused var warning
            if (jacobian__)
                nu = in__.scalar_lub_constrain(0, 100, lp__);
            else
                nu = in__.scalar_lub_constrain(0, 100);
            ...
            check_greater_or_equal(function__, "eta_n", eta_n, 0);
            current_statement_begin__ = 58;
            ...
            check_greater_or_equal(function__, "mu_n", mu_n, 0);
            current_statement_begin__ = 59;
            ...
            check_greater_or_equal(function__, "nu_n", nu_n, 0);
            current_statement_begin__ = 62;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_5_bremn_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double eta = in__.scalar_lub_constrain(-(1), 10);
        vars__.push_back(eta);
        double mu = in__.scalar_lub_constrain(0, 100);
        vars__.push_back(mu);
        double nu = in__.scalar_lub_constrain(0, 100);
        vars__.push_back(nu);
        double lp__ = 0.0;
...
typedef model_model_5_bremn_namespace::model_model_5_bremn stan_model;
#ifndef USING_R
