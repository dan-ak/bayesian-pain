...
#include "stanExports_model_5_bremn_var.h"

RCPP_MODULE(stan_fit4model_5_bremn_var_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_model_5_bremn_var")
