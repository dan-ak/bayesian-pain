...
namespace model_model_5_bremn_var_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_5_bremn_var");
    reader.add_event(132, 130, "end", "model_model_5_bremn_var");
    return reader;
}
...
class model_model_5_bremn_var
  : public stan::model::model_base_crtp<model_model_5_bremn_var> {
private:
        int N;
        ...
        int S;
public:
    model_model_5_bremn_var(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_5_bremn_var_namespace::model_model_5_bremn_var";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        mu_u = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(20, 80, mu_u);
        } catch (const std::exception& e) {
        ...
        try {
            writer__.scalar_lub_unconstrain(0, 100, rho_u);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 47;
        if (!(context__.contains_r("nu_u")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable nu_u missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("nu_u");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "nu_u", "double", context__.to_vec());
        double nu_u(0);
        nu_u = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 100, nu_u);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable nu_u: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 48;
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "beta_u", "double", context__.to_vec());
        double beta_u(0);
        beta_u = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 100, beta_u);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 49;
        if (!(context__.contains_r("eta_u")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable eta_u missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("eta_u");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "eta_u", "double", context__.to_vec());
        double eta_u(0);
        eta_u = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(-(10), 10, eta_u);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable eta_u: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 51;
        if (!(context__.contains_r("mu_s")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable mu_s missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("mu_s");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "mu_s", "double", context__.to_vec());
        double mu_s(0);
        mu_s = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 100, mu_s);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable mu_s: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 52;
        if (!(context__.contains_r("rho_s")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable rho_s missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("rho_s");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "rho_s", "double", context__.to_vec());
        double rho_s(0);
        rho_s = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, rho_s);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable rho_s: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 53;
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "nu_s", "double", context__.to_vec());
        double nu_s(0);
        nu_s = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 50, nu_s);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 54;
        if (!(context__.contains_r("beta_s")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable beta_s missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("beta_s");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "beta_s", "double", context__.to_vec());
        double beta_s(0);
        beta_s = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 50, beta_s);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable beta_s: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 55;
        if (!(context__.contains_r("eta_s")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable eta_s missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("eta_s");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "eta_s", "double", context__.to_vec());
        double eta_s(0);
        eta_s = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, eta_s);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable eta_s: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 57;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                mu_u = in__.scalar_lub_constrain(20, 80, lp__);
            else
                mu_u = in__.scalar_lub_constrain(20, 80);
            current_statement_begin__ = 46;
            local_scalar_t__ rho_u;
            (void) rho_u;  // dummy to suppress unused var warning
            if (jacobian__)
                rho_u = in__.scalar_lub_constrain(0, 100, lp__);
            else
                rho_u = in__.scalar_lub_constrain(0, 100);
            current_statement_begin__ = 47;
            local_scalar_t__ nu_u;
            (void) nu_u;  // dummy to suppress unused var warning
            if (jacobian__)
                nu_u = in__.scalar_lub_constrain(0, 100, lp__);
            else
                nu_u = in__.scalar_lub_constrain(0, 100);
            current_statement_begin__ = 48;
            local_scalar_t__ beta_u;
            (void) beta_u;  // dummy to suppress unused var warning
            if (jacobian__)
                beta_u = in__.scalar_lub_constrain(0, 100, lp__);
            else
                beta_u = in__.scalar_lub_constrain(0, 100);
            current_statement_begin__ = 49;
            local_scalar_t__ eta_u;
            (void) eta_u;  // dummy to suppress unused var warning
            if (jacobian__)
                eta_u = in__.scalar_lub_constrain(-(10), 10, lp__);
            else
                eta_u = in__.scalar_lub_constrain(-(10), 10);
            current_statement_begin__ = 51;
            local_scalar_t__ mu_s;
            (void) mu_s;  // dummy to suppress unused var warning
            if (jacobian__)
                mu_s = in__.scalar_lub_constrain(0, 100, lp__);
            else
                mu_s = in__.scalar_lub_constrain(0, 100);
            current_statement_begin__ = 52;
            local_scalar_t__ rho_s;
            (void) rho_s;  // dummy to suppress unused var warning
            if (jacobian__)
                rho_s = in__.scalar_lb_constrain(0, lp__);
            else
                rho_s = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 53;
            local_scalar_t__ nu_s;
            (void) nu_s;  // dummy to suppress unused var warning
            if (jacobian__)
                nu_s = in__.scalar_lub_constrain(0, 50, lp__);
            else
                nu_s = in__.scalar_lub_constrain(0, 50);
            current_statement_begin__ = 54;
            local_scalar_t__ beta_s;
            (void) beta_s;  // dummy to suppress unused var warning
            if (jacobian__)
                beta_s = in__.scalar_lub_constrain(0, 50, lp__);
            else
                beta_s = in__.scalar_lub_constrain(0, 50);
            current_statement_begin__ = 55;
            local_scalar_t__ eta_s;
            (void) eta_s;  // dummy to suppress unused var warning
            if (jacobian__)
                eta_s = in__.scalar_lb_constrain(0, lp__);
            else
                eta_s = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 57;
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("nu_u");
        names__.push_back("beta_u");
        names__.push_back("eta_u");
        names__.push_back("mu_s");
        names__.push_back("rho_s");
        names__.push_back("nu_s");
        names__.push_back("beta_s");
        names__.push_back("eta_s");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_5_bremn_var_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double mu_u = in__.scalar_lub_constrain(20, 80);
        vars__.push_back(mu_u);
        double rho_u = in__.scalar_lub_constrain(0, 100);
        vars__.push_back(rho_u);
        double nu_u = in__.scalar_lub_constrain(0, 100);
        vars__.push_back(nu_u);
        double beta_u = in__.scalar_lub_constrain(0, 100);
        vars__.push_back(beta_u);
        double eta_u = in__.scalar_lub_constrain(-(10), 10);
        vars__.push_back(eta_u);
        double mu_s = in__.scalar_lub_constrain(0, 100);
        vars__.push_back(mu_s);
        double rho_s = in__.scalar_lb_constrain(0);
        vars__.push_back(rho_s);
        double nu_s = in__.scalar_lub_constrain(0, 50);
        vars__.push_back(nu_s);
        double beta_s = in__.scalar_lub_constrain(0, 50);
        vars__.push_back(beta_s);
        double eta_s = in__.scalar_lb_constrain(0);
        vars__.push_back(eta_s);
    ...
    std::string model_name() const {
        return "model_model_5_bremn_var";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "nu_u";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "beta_u";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "eta_u";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "mu_s";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "rho_s";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "nu_s";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "beta_s";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "eta_s";
        param_names__.push_back(param_name_stream__.str());
        size_t beta_j_1_max__ = S;
        for (size_t j_1__ = 0; j_1__ < beta_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
...
typedef model_model_5_bremn_var_namespace::model_model_5_bremn_var stan_model;
#ifndef USING_R
