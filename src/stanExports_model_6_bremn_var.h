...
namespace model_model_6_bremn_var_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_6_bremn_var");
    reader.add_event(132, 130, "end", "model_model_6_bremn_var");
    return reader;
}
...
class model_model_6_bremn_var
  : public stan::model::model_base_crtp<model_model_6_bremn_var> {
private:
        int N;
        ...
        int S;
public:
    model_model_6_bremn_var(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_6_bremn_var_namespace::model_model_6_bremn_var";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_6_bremn_var_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_model_6_bremn_var";
    }
...
typedef model_model_6_bremn_var_namespace::model_model_6_bremn_var stan_model;
#ifndef USING_R
