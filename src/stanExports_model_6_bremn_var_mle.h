...
namespace model_model_6_bremn_var_mle_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_6_bremn_var_mle");
    reader.add_event(123, 121, "end", "model_model_6_bremn_var_mle");
    return reader;
}
...
class model_model_6_bremn_var_mle
  : public stan::model::model_base_crtp<model_model_6_bremn_var_mle> {
private:
        int N;
        ...
        int S;
public:
    model_model_6_bremn_var_mle(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_6_bremn_var_mle_namespace::model_model_6_bremn_var_mle";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_6_bremn_var_mle_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_model_6_bremn_var_mle";
    }
...
typedef model_model_6_bremn_var_mle_namespace::model_model_6_bremn_var_mle stan_model;
#ifndef USING_R
